...
<body>
		...
		try {
			...
			ResultSet getName = stmt.executeQuery("SELECT * FROM customers WHERE username ='" + session.getAttribute("user") + "'");
			getName.next();
			String firstName = getName.getString("first_name");
			String lastName = getName.getString("last_name");
